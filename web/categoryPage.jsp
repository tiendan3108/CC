    ...
    <body>
        <div id="main_container" ng-controller="loadCategoryPage">
            ...
            <div class="center_content">
                <div class="center_title_bar">${requestScope.category} Products</div>
                <div class="prod_box" ng-repeat="lap in laps| orderBy:'-price'">
                ...
                <div class="center_title_bar">
                    <button class="paginationButton" ng-click="previousPage()" ng-disabled="currentPage == 0">Previous</button>
                    <button class="paginationButton" ng-click="nextPage()" ng-disabled="currentPage == pageCount" >Next</button>
                </div>
            </div>
